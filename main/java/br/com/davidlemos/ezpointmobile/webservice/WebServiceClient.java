package br.com.davidlemos.ezpointmobile.webservice;
...
import br.com.davidlemos.ezpointmobile.util.WSConstants;
import br.com.davidlemos.ezpointmobile.util.WSUtil;
import br.com.davidlemos.ezpointmobile.models.AccessToken;
...
public class WebServiceClient {
    ...
    public static WebServiceResponse newAuthenticate(Context context,String email ,String password) {
        WebServiceResponse webServiceResponse = new WebServiceResponse();
        String baseAddress = WSUtil.getHostAddress(context);
        accessToken = null;
        try {
...
//            String grantType = generateGrantType(email, password);
//            conn.setDoOutput(true);
//            conn.setFixedLengthStreamingMode(grantType.length());
//            conn.getOutputStream().write(grantType.getBytes("UTF-8"));
//            conn.getOutputStream().flush();
